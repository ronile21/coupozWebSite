...
(function () {
  ...
  var translations = {
    en: {
      ...
      'sol.badge.title':  'Public overview',
      'sol.badge.sub':    'Details under NDA',

      /* PLATFORM OVERVIEW */ // change$$$
      'how.label':        'Platform overview',
      'how.h2':           'A business-facing activation platform for physical venues',
      'how.sub':          'This public overview keeps detailed product workflows private for NDA discussions.',
    ...
    th: {
      ...
      'sol.badge.title':  'ภาพรวมสาธารณะ',
      'sol.badge.sub':    'รายละเอียดภายใต้ NDA',

      /* PLATFORM OVERVIEW */ // change$$$
      'how.label':        'ภาพรวมแพลตฟอร์ม',
      'how.h2':           'แพลตฟอร์มการเปิดใช้งานสำหรับธุรกิจในสถานที่เชิงพาณิชย์',
      'how.sub':          'ภาพรวมสาธารณะนี้เก็บรายละเอียดเวิร์กโฟลว์ผลิตภัณฑ์ไว้สำหรับการพูดคุยภายใต้ NDA',
